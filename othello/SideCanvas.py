...
class UpperCanvas(tk.Canvas):
    def __init__(self, root):
        ...
        self.counter = tk.Label(self, text="White: 2", font=("Helvetica", 25), bg=BG_COLOR, fg="lightgray")
    ...
    def size_update(self, event):
        self.delete(tk.ALL)
        size = self.r.winfo_height() // 20
        self.counter['font'] = ("Helvetica", size)
...
class UnderCanvas(tk.Canvas):
    def __init__(self, root):
        ...
        self.hint = tk.Label(self, text="Your move...", font=("Helvetica", 25), bg=BG_COLOR)

        self.counter = tk.Label(self, text="Black: 2", font=("Helvetica", 25), bg=BG_COLOR, fg="lightgray")
